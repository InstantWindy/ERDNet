...
class cityscapes(Dataset):
    ...
    def __init__(self, root='/home/lulu/dataset/Cityscapes', co_transform=None, subset='train'):
...
class TestDataSet(Dataset):
    ...
    def __init__(self, root='/home/lulu/dataset/Cityscapes', co_transform=None,subset='test'):
        self.images_root = os.path.join(root, 'gtFine/images/')
		self.labels_root = os.path.join(root, 'gtFine/labels/')
        self.images_root += subset
        self.labels_root += subset
